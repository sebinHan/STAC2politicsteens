...
public class JungConPostDetailActivity extends BaseActivity2 implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_jung_detail);
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference()
                .child("jung_all_posts").child(mPostKey);
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                JungConPost post = dataSnapshot.getValue(JungConPost.class);
                //dataSnapshot.child("jung_posts").child(S.club_id+"").child(mPostKey).child("category").getValue();
                // [START_EXCLUDE]
               Log.d("fdsfdsaf","ddsad"+post.author);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(JungConPostDetailActivity.this, "Failed to load post.",
